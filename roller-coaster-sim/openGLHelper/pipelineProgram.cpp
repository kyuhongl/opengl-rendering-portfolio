...
void PipelineProgram::SetUniformVariable3f(const char * name, float v0, float v1, float v2)
{
  glUniform3f(GetUniformVariableHandle(name), v0, v1, v2);
}

void PipelineProgram::SetUniformVariable4f(const char * name, float v0, float v1, float v2, float v3)
{
  glUniform4f(GetUniformVariableHandle(name), v0, v1, v2, v3);
}

void PipelineProgram::SetUniformVariableMatrix3fv(const char * name, GLboolean transpose, float value[9])
{
  glUniformMatrix3fv(GetUniformVariableHandle(name), 1, transpose, value);
}
