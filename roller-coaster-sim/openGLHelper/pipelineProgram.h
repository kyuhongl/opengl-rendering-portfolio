...
public:
  ...
  // Set the uniform variable of type "3 floats"
  void SetUniformVariable3f(const char * name, float v0, float v1, float v2);
  // Set the uniform variable of type "4 floats"
  void SetUniformVariable4f(const char * name, float v0, float v1, float v2, float v3);
